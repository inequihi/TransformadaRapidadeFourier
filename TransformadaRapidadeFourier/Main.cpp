...
int main() {
	...
	if (f_n_txt.is_open())
	{
		//Aca tendria que asignarle con ALLOC/MALLOC el tamaño a los vectores f(n) y F(f)
		//ese tamaño cambia con la funcion checksize q es privada de la clase FastFourierTransform
